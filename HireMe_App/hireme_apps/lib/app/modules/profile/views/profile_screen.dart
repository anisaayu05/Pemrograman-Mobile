...
import '../controllers/profile_controller.dart'; // Pastikan controller diimport
  ...
  Widget _buildBottomNavigationBar() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(
          icon: Icon(Icons.check_circle, color: Color(0XFF9D9D9D)),
          label: 'Applied',
        ),
        BottomNavigationBarItem(
          icon: Icon(Icons.person, color: Color(0XFF1230AE)),
          label: 'Profile',
        ),
      ],
    );
