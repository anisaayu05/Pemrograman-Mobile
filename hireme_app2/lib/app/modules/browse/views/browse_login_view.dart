...
class BrowseLoginView extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
                        ...
                        itemBuilder: (context, index) {
                          if (index < controller.jobCategories.length) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Get.toNamed('/browse-2-login', arguments: category.name);
                              },
                              child: Card(
                            ...
                            return Center(
                              child: TextButton(
                                onPressed: () {
                                  Get.toNamed('/browse-2-login', arguments: 'All');
                                },
                                child: Row(
            ...
            // Tab 2: Recommended Jobs (same as BrowseView)
            Padding(
              padding: const EdgeInsets.all(16.0),
